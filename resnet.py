...
class CustomDatasetFromCSV(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        labels = torch.tensor(ast.literal_eval(self.data.iloc[idx, 1]), dtype=torch.int64)
...
train_csv = './splits/train_dataset.csv'
val_csv = './splits/val_dataset.csv'
test_csv = './splits/test_dataset.csv'
